# ✅ 2. coupang_gui.py (tkinter GUI 실행용 - 시트 분할, 수식 적용, 이미지 포함 최종 버전)
...
root = tk.Tk()
root.title("쿠팡 키워드 크롤러")
root.geometry("400x200")

label = tk.Label(root, text="검색 키워드를 입력하세요:")
label.pack(pady=10)

entry = tk.Entry(root, width=30)
entry.pack(pady=5)

button = tk.Button(root, text="크롤링 시작", command=start)
button.pack(pady=10)
